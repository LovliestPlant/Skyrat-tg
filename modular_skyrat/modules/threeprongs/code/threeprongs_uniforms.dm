/datum/greyscale_config/nk6_uniform
	name = "NK006 Uniform"
...
/datum/greyscale_config/nk6_uniform/worn
	name = "Worn NK006 Uniform"
	icon_file = 'modular_skyrat/modules/threeprongs/icons/nk6_trek.dmi'
...
/datum/greyscale_config/nk6_uniform/worn_digi
	name = "Worn Digitigrade NK006 Uniform"
	icon_file = 'modular_skyrat/modules/threeprongs/icons/nk6_trek_digi.dmi'
	//The worn json is exactly the same, so it's easier to just inherit it (EXPERIMENTAL - SUCCESS. TODO: REMOVE ALL (duplicate-of-obj)_WORN CONFIGS)
...
/obj/item/clothing/under/trek/nk006_cmd
	...
	greyscale_config = /datum/greyscale_config/nk6_uniform
	greyscale_config_worn = /datum/greyscale_config/nk6_uniform/worn
...
/obj/item/clothing/under/trek/nk006_cmd/Initialize(mapload)
	...
	greyscale_config_worn_bodytypes["[BODYTYPE_HUMANOID]"] = /datum/greyscale_config/nk6_uniform/worn
	greyscale_config_worn_bodytypes["[BODYTYPE_DIGITIGRADE]"] = /datum/greyscale_config/nk6_uniform/worn_digi*/
...
/obj/item/clothing/head/hats/nk006
	...
	icon = 'modular_skyrat/modules/threeprongs/icons/threeprongs_hats.dmi'
	worn_icon = 'modular_skyrat/modules/threeprongs/icons/threeprongs_hats.dmi'
	flags_inv = 0
