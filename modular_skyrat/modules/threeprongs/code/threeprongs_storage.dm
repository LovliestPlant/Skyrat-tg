/obj/item/storage/backpack/nk006
	...
	icon = 'modular_skyrat/modules/threeprongs/icons/threeprongs_storage_item.dmi'
	worn_icon = 'modular_skyrat/modules/threeprongs/icons/threeprongs_storage_worn.dmi'
