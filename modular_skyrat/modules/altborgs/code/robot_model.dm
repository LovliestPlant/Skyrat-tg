...
/obj/item/robot_model/service
	...
	borg_skins = list(
		"Drake" = list(SKIN_ICON = CYBORG_ICON_SERVICE_WIDE, SKIN_ICON_STATE = "drakeserv", SKIN_FEATURES = list(R_TRAIT_UNIQUEWRECK, R_TRAIT_WIDE)),
		"T3R1N Unique" = list(SKIN_ICON = CYBORG_ICON_CUSTOM_WIDE, SKIN_ICON_STATE = "t3r1n", SKIN_FEATURES = list(R_TRAIT_UNIQUEWRECK, R_TRAIT_WIDE)),
		"NAAKO-6 Unique" = list(SKIN_ICON = CYBORG_ICON_CUSTOM_WIDE, SKIN_ICON_STATE = "naako-6", SKIN_FEATURES = list(R_TRAIT_UNIQUEWRECK, R_TRAIT_WIDE)),
