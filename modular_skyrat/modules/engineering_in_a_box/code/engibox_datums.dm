...
/area/misc/survivalpod/tcomms_box
	name = "\improper Telecommunications in a Box"
	icon_state = "away"
	static_lighting = FALSE
	requires_power = TRUE
	has_gravity = STANDARD_GRAVITY
...
/datum/map_template/shelter/tesla
	...
	description = "Attach to a busted station or a new outpost for instant megawatts of power!"
	mappath = "modular_skyrat/modules/engineering_in_a_box/maps/tesla_in_a_box.dmm"
...
/datum/map_template/shelter/singulo
	...
	description = "Attach to a busted station or a new outpost for instant megawatts of power!"
	mappath = "modular_skyrat/modules/engineering_in_a_box/maps/singulo_in_a_box.dmm"
