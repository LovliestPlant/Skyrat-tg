...
/obj/item/cautery/advanced
	...
	light_range = 1
	light_color = LIGHT_COLOR_NORANGE
...
/obj/item/cautery/advanced/proc/on_transform(obj/item/source, mob/user, active)
	...
	if(active)
		set_light_color(LIGHT_COLOR_NVIOLET)
	else
		set_light_color(LIGHT_COLOR_NORANGE)
...
/obj/item/scalpel/advanced/proc/on_transform(obj/item/source, mob/user, active)
	...
	if(active)
		...
		tool_behaviour = TOOL_SCALPEL
		set_light_color(LIGHT_COLOR_NLIME)
